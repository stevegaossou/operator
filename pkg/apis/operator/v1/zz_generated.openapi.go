			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"clusterManagementType": {
						SchemaProps: spec.SchemaProps{
							Description: "For typical setups the default value is \"standalone\". For a scenario with multiple clusters, one \"management\" cluster can be configured to establish a secure connection with one or more \"managed\" clusters. Valid values for this field are: \"standalone\", \"management\", \"managed\"",
							Type:        []string{"string"},
							Format:      "",
						},
					},
